  ...
  return (
    <div className="flex h-screen overflow-hidden bg-gray-100">
      ...
      <div className="flex-1 overflow-auto focus:outline-none">
        <div className="relative z-10 flex flex-shrink-0 h-16 bg-white border border-gray-200">
          <button
              ...
              <form className="flex w-full md:ml-0" action="#" method="GET">
                ...
                <div className="relative w-full text-gray-400 focus-within:text-gray-600">
                  ...
                  <input
                    id="search_field"
                    name="search_field"
                    className="block w-full h-full py-2 pl-8 pr-3 text-2xl text-gray-900 placeholder-gray-500 border-transparent focus:outline-none focus:ring-0 focus:border-transparent sm:text-sm"
